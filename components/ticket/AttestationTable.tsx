...
async function buildReprintHtml(a: AttestationRow, bureau: {
  ...
  const montantLettres = mgaToWords(a.totalMGA)
  ...
  <table class="details-table">
    ...
    <tbody>
      <tr>
        ...
        <td>${a.rate > 0 ? `${formatNum(a.rate)} Ar/${a.currencyCode}` : '—'}</td>  // ✅ Vrai taux ou "—"
        <td>${a.rate > 0 ? formatMGA(a.amount * a.rate) : formatMGA(a.totalMGA)}</td>  // ✅ Montant correct
      </tr>
...
<div class="amount-box">
  <div class="amount-main">
    ...
    <span class="amount-value">${formatMGA2(a.totalMGA)}</span>
  </div>
